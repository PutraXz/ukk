	...
	<div class="container-fluid text-center">    
		<div class="row content">
			<div class="col-sm-2 sidenav">
				<p><a href="#" onclick="document.getElementById('transaksi').style.display='block'">Tambah Data</a></p>
			</div>
					...
					<?php
						...
						if($page=='hapus'){
							if($_SESSION == 'admin'){
								...
								$del = $conn->query("delete from pembayaran where id_pembayaran='$id_pembayaran'");
								if($del){
									echo "
									<script>
